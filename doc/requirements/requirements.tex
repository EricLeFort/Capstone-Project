...
%***Removals***
%Force from actuator should be adjustable -- A subset of the "move end-effector appropriately" requirement.
%Small repeatability area (same spot every time) -- fit criterion for move end-effector appropriately.
%End effector needs to provide enough force to shoot. -- not really a requirement, just a fit criterion for "move end effector appropriately"
%UH: Player should be able to interrupt machine's turn. -- Functional, included in "take in user input"
%OE: Will be in regular pool playing environments -- moved to a constraint
%OE: Pool table properties must be consistent -- already constrained
%MS: Tested weekly -- I don't know about this as a requirement
%L: All high voltage components should have circuit breakers -- Remove, duplicate
...
\subsubsection{Maintainability \& Support Requirements}%TODO remove?
...
\begin{framed}
	\noindent\textbf{Requirement \#}: 2 \hfill \textbf{Requirement Type}:SA \hfill\\\\
...
\begin{framed}
	\noindent\textbf{Requirement \#}: 3 \hfill \textbf{Requirement Type}:SA \hfill\\\\
...
\begin{framed}
	\noindent\textbf{Requirement \#}: 4 \hfill \textbf{Requirement Type}:SA \hfill\\\\
