...
\begin{tabular}{| C{3} | C{2} | C{5} | C{2.5} |}\hline
	...
	24/03/2017	&2	Added sections to Mechanical System to detail low level components	&Guy Meyer\\\hline
	25/03/2017	&3	Added Pneumatic section to Mechanical System along with low level mechanical adjustments	&Guy Meyer\\\hline
\end{tabular}
...
% TODO: NEED TO ADD NEMA 17 Motor holder and pulley holder	TODO: Just need Overall -Y Rail  Full Picture
...
% Complete: (only needs pictures) <- TODO
...
\textbf{Description}\\
The Arm Bolts (labeled B1,2,3,4 in the exploded veiw) are used to couple the Arm to the Arm Base.\\\
\textbf{Requirements}\\
...
\begin{center}
	\includegraphics[width = 0.9\textwidth]{armBase.png}	% TODO: Include new picture
...
\begin{center}
	\includegraphics[width = 0.9\textwidth]{endEffector.png}	% TODO: Include standard picture:	sm2_standard.png
...
% Rod hinge attachment for piston tip
...
\begin{center}
	\includegraphics[width = 0.9\textwidth]{efBase.png}	% TODO: Include new picture
...
\begin{center}
	\includegraphics[width = 0.9\textwidth]{efArm.png}	% TODO: Include new picture
...
% pneumatic piston		1/2" Bore, 3" Stroke piston
...
% 10/32" fittings for small piston
