...
\section{Overview}
%TODO document overview, state that descriptions of system and/or components can be found in the appropriate documents.
...
%List of hazards:
%Person injured due to a ``pinch point''.
%Pneumatic striking person, table, or machine.
%Pool ball jumping off the table and injuring a person or damaging property.
%Machine injures person while traversing the table.
%Loose clothing/jewellery/long hair getting caught in the machine.
\section{Hazards}
%TODO section description, high-level system FTA diagram (each section will elaborate on its specific hazard tree.
\subsection{HAZARD-NAME}
%TODO Hazard description, plans for avoidance and/or mitigation, provide detailed subset of FTA for appropriate FTA section
