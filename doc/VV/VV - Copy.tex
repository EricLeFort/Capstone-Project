...
\begin{tabular}{|l r|}\hline&\\[-2mm]
	Test ID: 12.1	&Status: TBT\\[-3mm]
	\multicolumn{2}{|c|}{\textbf{\large{Sychronious Motion in X Rail}}}\\&\\\hline&\\[-3mm]
...
\end{tabular}
\caption{Sychronious Motion in X Rail}
\end{table}
\end{center}
...
\begin{table}
\begin{tabular}{|l r|}\hline&\\[-2mm]
	Test ID: 13.1	&Status: TBT\\[-3mm]
	\multicolumn{2}{|c|}{\textbf{\large{Shooting Command}}}\\&\\\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Description: Arduino received command to take shot}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pass/Fail Condition: Arduino initiates shot taking process}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pre-Conditions: System powered on and ready to change states}\\[4mm]
	\multicolumn{2}{|p{\textwidth}|}{Input: Command to Arduino to take shot}\\[2mm]\hline
	\multicolumn{1}{|p{0.49\textwidth}}{Expected Results: User commands system to shoot. Arduino initiates shot taking process.}	&\multicolumn{1}{|p{0.45\textwidth}|}{Actual Results:}\\\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Post-Conditions: Shot is taken and balls are settled}\\\hline
\end{tabular}
\caption{Shooting Command}
\end{table}
\end{center}
...
\begin{table}
\begin{tabular}{|l r|}\hline&\\[-2mm]
	Test ID: 14.1	&Status: TBT\\[-3mm]
	\multicolumn{2}{|c|}{\textbf{\large{User Input to Arduino}}}\\&\\\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Description: User applies input, then the Arduino indicated a received message}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pass/Fail Condition:Arduino output to console correct desired status}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pre-Conditions: None}\\[4mm]
	\multicolumn{2}{|p{\textwidth}|}{Input: User pressed status button}\\[2mm]\hline
	\multicolumn{1}{|p{0.49\textwidth}}{Expected Results: Console output}	&\multicolumn{1}{|p{0.45\textwidth}|}{Actual Results:}\\\hline&\\[-3mm]
...
\begin{table}
\begin{tabular}{|l r|}\hline&\\[-2mm]
	Test ID: 14.2	&Status: TBT\\[-3mm]
	\multicolumn{2}{|c|}{\textbf{\large{Emergency Stop}}}\\&\\\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Description: Stop command during runtime}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pass/Fail Condition: Upon user request the system stops immediately}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pre-Conditions: System is preforming an action}\\[4mm]
	\multicolumn{2}{|p{\textwidth}|}{Input: Stop command is sent}\\[2mm]\hline
	\multicolumn{1}{|p{0.49\textwidth}}{Expected Results: System halts immediately along with visual indication}	&\multicolumn{1}{|p{0.45\textwidth}|}{Actual Results:}\\\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Post-Conditions: System is motion unless and awaiting next command}\\\hline
\end{tabular}
...
\begin{table}
\begin{tabular}{|l r|}\hline&\\[-2mm]
	Test ID: 15.1	&Status: TBT\\[-3mm]
	\multicolumn{2}{|c|}{\textbf{\large{Move Away Command}}}\\&\\\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Description: Physical system is interfering with players ability to approach the table. The user commands the system to move over}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pass/Fail Condition: Upon user command the system moves to predetermined location}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pre-Conditions: None}\\[4mm]
	\multicolumn{2}{|p{\textwidth}|}{Input: Command to Arduino to move in desired location on either side of table}\\[2mm]\hline
	\multicolumn{1}{|p{0.49\textwidth}}{Expected Results: System indicates acceptance of command and preforms action. Upon completion the system stops.}	&\multicolumn{1}{|p{0.45\textwidth}|}{Actual Results:}\\\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Post-Conditions: System is motionless and awaits next command.}\\\hline
\end{tabular}
\caption{Move Away Command}
\end{table}
\end{center}
...
\begin{table}
\begin{tabular}{|l r|}\hline&\\[-2mm]
	Test ID: 17.1	&Status: TBT\\[-3mm]
	\multicolumn{2}{|c|}{\textbf{\large{Random Shot Request}}}\\&\\\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Description: User can initiate shot taking process at any time}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pass/Fail Condition: During arbitrary state the user requests to attempt shot and the system initiates shot taking process}\\[1mm]\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Pre-Conditions: Arbitrary state}\\[4mm]
	\multicolumn{2}{|p{\textwidth}|}{Input: Take a Shot command}\\[2mm]\hline
	\multicolumn{1}{|p{0.49\textwidth}}{Expected Results: System switches state and initiates shot taking sequence}	&\multicolumn{1}{|p{0.45\textwidth}|}{Actual Results:}\\\hline&\\[-3mm]
	\multicolumn{2}{|p{\textwidth}|}{Post-Conditions:  None}\\\hline
\end{tabular}
\caption{Random Shot Request}
\end{table}
\end{center}
...
%TODO Requirements checked: F1, F2
